...
@section('title', 'Pengajuan Pembatalan Pencairan')

@section('content')
<div class="main-content" style="margin-bottom: 100px">
    <section class="section">
        <div class="section-header">
            <h1>Pembatalan Pencairan - Mahasiswa Baru</h1>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            <tr>
                                <td>Kategori</td>
                                <td>: Pembatalan Pencairan Baru</td>
                            </tr>
                            <tr>
        ...
        <div class="alert alert-warning" role="alert">
            ...
            sudah terdata sebagai mahasiswa ditetapkan dan yang sudah melakukan penetapan awal.
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="pengajuan">
                ...
                <form method="POST"
                    action="{{ route('pencairan.baru.pembatalan.store', ['periode_id' => $periode->id]) }}"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td>
                                    @if ($item->status_mahasiswa != 'nonaktif' && !count($item->pencairan))
                                ...
                                <td>
                                    ...
                                    @if ($item->pencairan[0]->status == 'ditolak')
