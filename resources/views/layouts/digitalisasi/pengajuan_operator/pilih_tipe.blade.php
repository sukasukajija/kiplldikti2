    ...
    <section class="section">
        ...
        <div class="container" style="margin-top: 20vh">
            ...
            <div class="row" style="margin-bottom: 80px">
                <div class="col-12 text-center">
                    <button class="btn btn-primary btn-lg" style="font-size: 24px; padding: 32px 48px;">
                        <a href="{{ route('pengajuan_penetapan.upload_dokumen', ['periode_id' => request('periode_id'), 'tipe' => 'baru']) }}"
            ...
            <div class="row mb-3">
                <div class="col-12 text-center">
                    <button class="btn btn-primary btn-lg" style="font-size: 24px; padding: 32px 48px;">
                        <a href="{{ route('pengajuan_penetapan.upload_dokumen', ['periode_id' => request('periode_id'), 'tipe' => 'ongoing']) }}"
