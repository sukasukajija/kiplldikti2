...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Upload Dokumen - Pembatalan Pencairan Ongoing</h1>
        </div>


      <form action="{{ route('pencairan.ongoing.pembatalan.upload-sk.post', ['periode_id' => $periode_id, 'jenis_bantuan_id' => $jenis_bantuan_id]) }}" method="POST" accept="application/pdf" enctype="multipart/form-data">
          @csrf
          <div class="form-group">
              <label for="file_sk">Upload SK Pembatalan (PDF)</label>
